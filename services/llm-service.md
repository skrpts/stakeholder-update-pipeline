...
id: llm-service
title: LLM Service
description: "Language model service providing stakeholder communication and executive reporting capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for stakeholder communication and executive reporting. Used by all skills in this skrpt.
